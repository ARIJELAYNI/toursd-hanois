...
public class DemoLandscapeView extends JouerLandscapeView implements
	...
	public DemoLandscapeView(Context context) {
	...
	private final class DrawingThread extends Thread {
		...
		DemoLandscapeView msurfacePanel;

		public DrawingThread(SurfaceHolder sholder, Context ctx,
				DemoLandscapeView spanel) {
